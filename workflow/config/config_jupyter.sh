...
python3 -m pip install -r ./config/requirements.txt --upgrade

# download latest postgres driver jar
POSTGRES_JAR="./config/postgresql-42.2.10.jar"
...
sudo cp ./config/log4j.properties /usr/local/spark/conf/log4j.properties
